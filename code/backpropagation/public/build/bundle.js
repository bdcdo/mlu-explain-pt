var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			meta6 = element("meta");
    			meta7 = element("meta");
    			document.title = "MLU-Explain: Retropropagacao (Backpropagation)";
    			attr(meta0, "charset", "utf-8");
    			attr(meta1, "http-equiv", "X-UA-Compatible");
    			attr(meta1, "content", "IE=edge");
    			attr(meta2, "name", "viewport");
    			attr(meta2, "content", "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no");
    			attr(meta3, "name", "description");
    			attr(meta3, "content", "Uma introducao visual e interativa a Retropropagacao (Backpropagation) em redes neurais.");
    			attr(meta4, "property", "og:title");
    			attr(meta4, "content", "Retropropagacao (Backpropagation)");
    			attr(meta5, "property", "og:description");
    			attr(meta5, "content", "Aprenda como redes neurais aprendem atraves da retropropagacao de gradientes.");
    			attr(meta6, "property", "og:image:width");
    			attr(meta6, "content", "1000");
    			attr(meta7, "property", "og:image:height");
    			attr(meta7, "content", "630");
    		},
    		m(target, anchor) {
    ...
    class Meta extends SvelteComponent {
    	constructor(options) {
    		super();
    		init$1(this, options, null, create_fragment$7, safe_not_equal, {});
    	}
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			t0 = space();
    			h2 = element("h2");
    			h2.innerHTML = `MLU-EXPL<span id="ai" class="svelte-htd26v">AI</span>N`;
    			attr(path0, "d", "M90.6641 83.1836C96.8828 83.1836 101.941 78.1289 101.941 71.8906V71.8242C101.941 65.5898 96.8945 60.5312 90.6641 60.5312C84.4453 60.5312 79.3828 65.5898 79.3828 71.8242V71.8906C79.3828 78.1289 84.4336 83.1836 90.6641 83.1836Z");
    			attr(path0, "fill", /*robotLogoColor*/ ctx[1]);
    			attr(path1, "d", "M143.305 83.1836C149.523 83.1836 154.586 78.1289 154.586 71.8906V71.8242C154.586 65.5898 149.535 60.5312 143.305 60.5312C137.09 60.5312 132.027 65.5898 132.027 71.8242V71.8906C132.027 78.1289 137.078 83.1836 143.305 83.1836Z");
    			attr(path1, "fill", /*robotLogoColor*/ ctx[1]);
    			attr(path2, "d", "M163.586 159.402H173.609V122.641H163.586V159.402Z");
    			attr(path2, "fill", /*robotLogoColor*/ ctx[1]);
    			attr(path3, "d", "M60.3594 159.402H70.3867V122.641H60.3594V159.402Z");
    			attr(path3, "fill", /*robotLogoColor*/ ctx[1]);
    			attr(path4, "d", "M182.16 30.0781H51.8047V10.0234H182.16V30.0781ZM182.16 103.609H51.8047V40.1055H182.16V103.609ZM144.559 168.789H89.4062V113.641H144.559V168.789ZM0 0V10.0234H15.8789V46.7891H25.9023V10.0234H41.7812V113.641H79.3867V178.816H96.9297V215.578H106.957V178.816H127.016V215.578H137.039V178.816H154.586V113.641H192.188V10.0234H233.969V0");
    			attr(path4, "fill", /*robotLogoColor*/ ctx[1]);
    			attr(g2, "id", "mlu_robot 1");
    			attr(g2, "clip-path", "url(#clip0)");
    			attr(rect, "width", "233.97");
    			attr(rect, "height", "215.58");
    			attr(rect, "fill", "black");
    			attr(clipPath, "id", "clip0");
    			attr(svg, "width", "30");
    			attr(svg, "height", "30");
    			attr(svg, "viewBox", "0 0 234 216");
    			attr(h2, "class", "logo svelte-htd26v");
    			attr(a, "href", "https://mlu-explain.github.io");
    			attr(a, "class", "svelte-htd26v");
    			attr(div, "id", "intro-icon");
    			set_style(div, "--ai-color", /*aiLogoColor*/ ctx[0]);
    			attr(div, "class", "svelte-htd26v");
    		},
    		m(target, anchor) {
    ...
    class Logo extends SvelteComponent {
    	constructor(options) {
    		super();
    		init$1(this, options, instance$2, create_fragment$6, safe_not_equal, { aiLogoColor: 0, robotLogoColor: 1 });
    	}
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			section.innerHTML = `<h1 id="intro-hed" class="svelte-128f2xi">Retropropagacao</h1> 
  <h1 class="intro-sub svelte-128f2xi">Uma introducao visual a como redes neurais aprendem.</h1> 
  <h3 id="intro__date" class="svelte-128f2xi">Março 2026</h3>`;

    			attr(section, "id", "intro");
    			attr(section, "class", "svelte-128f2xi");
    		},
    		m(target, anchor) {
    ...
    */
    ...
    function create_fragment$4(ctx) {
    	...
    	let t14;
    	let html_tag;
    	let raw_value = katexify("\\frac{\\partial L}{\\partial w}") + "";
    	let t15;
    	let t16;
    	let br2;
    	let t17;
    	...
    	return {
    		c() {
    			...
    			p0.innerHTML = `Como uma rede neural aprende? O segredo esta em um algoritmo chamado
    <strong>retropropagacao (backpropagation)</strong>. Ele e o motor que
    permite que redes neurais ajustem seus pesos internos para fazer
    predicoes cada vez mais precisas.`;
    			...
    			p1.innerHTML = `A ideia central e simples: primeiro, a rede faz uma predicao
    (<em>propagacao direta</em>). Depois, ela mede o quanto errou
    (<em>funcao de perda</em>). Finalmente, ela propaga esse erro de volta
    pela rede, ajustando os pesos de cada conexao para reduzir o erro
    na proxima vez.`;
    			...
    			t11 = space();
    			p2 = element("p");
    			t12 = text("Matematicamente, a retropropagacao usa a ");
    			strong1 = element("strong");
    			strong1.textContent = "regra da cadeia";
    			t14 = text("\n    do calculo diferencial para calcular como cada peso individual\n    contribui para o erro total. O gradiente\n    ");
    			html_tag = new HtmlTag(false);
    			t15 = text("\n    nos diz exatamente o quanto e em que direcao cada peso deve mudar.");
    			t16 = space();
    			br2 = element("br");
    			t17 = space();
    			p3 = element("p");

    			p3.innerHTML = `Vamos visualizar esse processo passo a passo em uma rede neural
    simples com <strong>2 entradas</strong>, <strong>3 neuronios ocultos</strong>
    e <strong>1 saida</strong>. Role para baixo para acompanhar cada etapa.`;

    			attr(p0, "class", "body-text");
    			attr(p1, "class", "body-text");
    			html_tag.a = t15;
    			attr(p2, "class", "body-text");
    			attr(p3, "class", "body-text");
    			attr(section, "id", "intro-text");
    			attr(section, "class", "svelte-1p0phe1");
    		},
    		m(target, anchor) {
    			insert(target, section, anchor);
    			append(section, p0);
    ...
    function createNeuralNetwork(selector) {
    ...
    function createLossChart(selector) {
      const container = select(selector);
      if (container.empty()) return null;
      ...
      const xScale = linear().domain([0, 15]).range([0, innerW]);
      const yScale = linear().domain([0, 0.55]).range([innerH, 0]);
    ...
    /* src/Components/ScrollyBackprop.svelte generated by Svelte v3.59.2 */
    ...
    // (127:8) {#each steps as text, i}
    function create_each_block(ctx) {
    	let div1;
    	let div0;
    	let raw_value = /*text*/ ctx[7] + "";

    	return {
    		c() {
    			div1 = element("div");
    			div0 = element("div");
    			attr(div0, "class", "step-content svelte-geeso8");
    			attr(div1, "class", "step svelte-geeso8");
    			toggle_class(div1, "active", /*value*/ ctx[0] === /*i*/ ctx[9]);
    		},
    		m(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			div = element("div");
    			attr(div, "class", "spacer svelte-geeso8");
    		},
    		m(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			div3.innerHTML = `<div class="chart-one svelte-geeso8" id="nn-container"></div> 
      <div class="chart-two svelte-geeso8" id="loss-container"></div>`;

    			attr(div0, "class", "steps-container svelte-geeso8");
    			attr(div3, "class", "charts-container svelte-geeso8");
    			attr(div4, "class", "section-container svelte-geeso8");
    		},
    		m(target, anchor) {
    			insert(target, section, anchor);
    			append(section, div4);
    ...
    function instance($$self, $$props, $$invalidate) {
     ...
     neurais aprendem!</p>`
    	...
    	return [value, steps, mounted, scrolly_value_binding];
    }

    class ScrollyBackprop extends SvelteComponent {
    	constructor(options) {
    		super();
    		init$1(this, options, instance, create_fragment$2, safe_not_equal, {});
    	}
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	let t15;
    	let html_tag;
    	let raw_value = katexify("\\frac{\\partial L}{\\partial w} = \\frac{\\partial L}{\\partial \\hat{y}} \\cdot \\frac{\\partial \\hat{y}}{\\partial z} \\cdot \\frac{\\partial z}{\\partial w}") + "";
    	let t16;
    	let t17;
    	let br2;
    	let t18;
    	...
    	return {
    		c() {
    			section = element("section");
    			h1 = element("h1");
    			h1.textContent = "Conclusao";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "A retropropagacao (backpropagation) e o algoritmo fundamental que permite\n    redes neurais aprenderem a partir de dados. O processo pode ser resumido\n    em tres etapas que se repetem ciclicamente:";
    			t3 = space();
    			br0 = element("br");
    			t4 = space();
    			ol = element("ol");

    			ol.innerHTML = `<li class="svelte-m489g3"><strong>Propagacao direta (forward pass)</strong>: os dados de entrada
      fluem pela rede, camada por camada, ate gerar uma predicao.</li> 
    <li class="svelte-m489g3"><strong>Calculo da perda</strong>: a funcao de perda quantifica a
      diferenca entre a predicao e o valor real.</li> 
    <li class="svelte-m489g3"><strong>Propagacao reversa (backward pass)</strong>: os gradientes da
      perda sao propagados de volta pela rede usando a regra da cadeia,
      e os pesos sao atualizados por descida do gradiente.</li>`;

    			t13 = space();
    			br1 = element("br");
    			t14 = space();
    			p1 = element("p");
    			t15 = text("A elegancia da retropropagacao esta na regra da cadeia:\n    ");
    			html_tag = new HtmlTag(false);
    			t16 = text("\n    — ela nos permite calcular eficientemente como cada peso individual\n    afeta o erro final, mesmo em redes com milhoes de parametros.");
    			t17 = space();
    			br2 = element("br");
    			t18 = space();
    			p2 = element("p");
    			p2.textContent = "Este artigo visualizou o processo em uma rede simples (2-3-1), mas o\n    mesmo principio se aplica a arquiteturas muito mais complexas, como redes\n    convolucionais (CNNs) e transformers. A retropropagacao e, sem exagero,\n    o algoritmo que tornou possivel a revolucao do deep learning.";
    			attr(h1, "class", "body-header");
    			attr(p0, "class", "body-text");
    			attr(ol, "class", "body-text conclusion-list svelte-m489g3");
    			html_tag.a = t16;
    			attr(p1, "class", "body-text");
    			attr(p2, "class", "body-text");
    			attr(section, "id", "conclusion");
    			attr(section, "class", "svelte-m489g3");
    		},
    		m(target, anchor) {
    			insert(target, section, anchor);
    			append(section, h1);
    ...
    class Conclusion extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function create_fragment(ctx) {
    	...
    	title = new Title({});
    	intro = new Intro({});
    	scrollybackprop = new ScrollyBackprop({});
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			create_component(scrollybackprop.$$.fragment);
    			t4 = space();
    		...
    		m(target, anchor) {
    			...
    			mount_component(scrollybackprop, target, anchor);
    		...
    		i(local) {
    			...
    			transition_in(scrollybackprop.$$.fragment, local);
    		...
    		o(local) {
    			...
    			transition_out(scrollybackprop.$$.fragment, local);
    		...
    		d(detaching) {
    			...
    			destroy_component(scrollybackprop, detaching);
